...
const Question = ({ idx, question,quesimg, a, b, c, d, correct, response }) => {
  return (
    <View style={styles.view}>
      {question!=null?<Text style={styles.question}>{`Q${idx}. ${question}`}</Text>:<>
      <Text style={styles.question}>{`Q${idx}.`}</Text>
      <Image  src={quesimg} />
      </>}
    ...
    <Document>
      <Page style={styles.page}>
        <View style={styles.company}>
          ...
          <Text style={styles.capp}>Electromagnetic Spectrum Trivia</Text>
        </View>
        ...
        {data.map((question, idx) => (
          <Question
            ...
            quesimg={!question.question ? question.quesimg : null}
            a={question.a}
            b={question.b}
            c={question.c}
            d={question.d}
